...
- [Technical Specification](./docs/technical/TechSpec.md) - Детальная техническая спецификация
- [API Specification](./docs/technical/API.md) - REST API и WebSocket события
- [Database Schema](./docs/technical/Database.md) - Схема БД (29 таблиц)
