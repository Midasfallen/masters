...
// in service_platform/test/repositories/auth_repository_test.dart.
...
import 'package:service_platform/core/api/dio_client.dart' as _i4;
...
class MockDioClient extends _i1.Mock implements _i4.DioClient {
  ...
  @override
  _i5.Future<_i2.Response<T>> uploadBytes<T>(
    String? path,
    List<int>? bytes, {
